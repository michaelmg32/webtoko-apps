...
<div class="min-h-screen bg-[#fcfcfd] pb-12">
    <div class="bg-white border-b border-gray-100 shadow-sm/5">
        <div class="max-w-4xl mx-auto px-6 py-5 flex justify-between items-end">
            <div>
                ...
                <h1 class="text-xl font-bold text-gray-900 tracking-tight">Edit Informasi Produk</h1>
            </div>
    ...
    <div class="max-w-4xl mx-auto px-6 mt-10">
        <div class="bg-white rounded-[2rem] shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
            ...
            <form action="{{ route('admin.products.update', $product->id) }}" method="POST" class="p-8 md:p-12">
                @csrf
                @method('PUT')

                <div class="flex items-center gap-3 bg-gray-50 w-max px-4 py-2 rounded-xl border border-gray-100 mb-8">
                    <span class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Editing:</span>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            ...
                            <select name="category" required
                                class="w-full pl-11 pr-10 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 focus:bg-white transition-all outline-none text-gray-700 appearance-none">
                                <option value="cetak" {{ old('category', $product->category) === 'cetak' ? 'selected' : '' }}>Cetak</option>
                                <option value="studio" {{ old('category', $product->category) === 'studio' ? 'selected' : '' }}>Studio</option>
                                <option value="barang" {{ old('category', $product->category) === 'barang' ? 'selected' : '' }}>Barang</option>
                            </select>
                    ...
                    <div class="group">
                        ...
                        <div class="flex gap-3 items-center">
                            <div class="relative flex-1">
                                ...
                                <input type="number" name="stock" id="stockInput" value="{{ old('stock', $product->stock) }}" min="0"
                    ...
                    <div class="md:col-span-2 mt-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="group">
                                <label class="block text-xs font-black text-gray-500 uppercase tracking-widest mb-2 ml-1 group-focus-within:text-indigo-500 transition-colors">Harga Konsumen Umum</label>
                                <div class="relative">
                            ...
                            <div class="group">
                                <label class="block text-xs font-black text-gray-500 uppercase tracking-widest mb-2 ml-1 group-focus-within:text-indigo-500 transition-colors">Harga Amatir / Reseller</label>
                                <div class="relative">
                                    <span class="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-400 font-bold text-sm">Rp</span>
                                    <input type="number" name="amatir_price" value="{{ old('amatir_price', $product->amatir_price) }}" required
                                        class="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-200 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 focus:bg-white transition-all outline-none text-lg font-bold text-gray-700">
                                </div>
                            </div>
                        </div>
